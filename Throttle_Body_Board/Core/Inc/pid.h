...
#define _PID_SAMPLE_TIME_MS_DEF 10
...
void PID(PID_TypeDef *uPID, volatile int32_t *Input, int32_t *Output, int32_t *Setpoint, double Kp, double Ki, double Kd, PIDPON_TypeDef POn, PIDCD_TypeDef ControllerDirection);
void PID2(PID_TypeDef *uPID, volatile int32_t *Input, int32_t *Output, int32_t *Setpoint, double Kp, double Ki, double Kd, PIDCD_TypeDef ControllerDirection);

void PID_Set_Setpoint(PID_TypeDef *uPID, int32_t *setpoint);
/* ::::::::::: Computing ::::::::::: */
