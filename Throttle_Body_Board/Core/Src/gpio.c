...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, HBRIDGE_DECAY_Pin|HBRIDGE_OCPM_Pin|HBRIDGE_MODE2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : HBRIDGE_EN_Pin */
  ...
  /*Configure GPIO pins : HBRIDGE_DECAY_Pin HBRIDGE_OCPM_Pin HBRIDGE_MODE2_Pin */
  GPIO_InitStruct.Pin = HBRIDGE_DECAY_Pin|HBRIDGE_OCPM_Pin|HBRIDGE_MODE2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
